      ...
      <div className="relative bg-white rounded-sm shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-8 md:p-12">
          ...
          <p className="text-center text-gray-600 mb-10 font-light">
            Detalhes sobre a modalidade Individual
          </p>

          <div className="space-y-6">
            <div className="border-2 border-stone-200 rounded-sm p-8 hover:border-amber-700 transition-all duration-300 hover:shadow-lg">
              <div className="flex items-start gap-4 mb-4">
                <div className="w-12 h-12 bg-amber-50 rounded-full flex items-center justify-center transition-colors duration-300">
              ...
              <a
                href="https://wa.me/5521969886267?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20o%20curso%20Individual%20-%20Entre%20Louças%20e%20Gestos"
                target="_blank"
